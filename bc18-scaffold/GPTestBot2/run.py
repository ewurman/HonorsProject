...
def Mutate(decisionTree, probabilityPerNode, probOfMutate, allFunctionSets, decisionToSubtreeProb = 0.0) -> (DecisionTree, int):
    ''' NEW IMPLEMENTATION
...
gc.queue_research(bc.UnitType.Mage)
gc.queue_research(bc.UnitType.Mage)
gc.queue_research(bc.UnitType.Mage) #blink
while True:
