'''
    Warning: this is the sandbox file. Only use for testing
'''
...
class BooleanNode(Node):
    ...
    def evaluate(self, battleCode, gc, moreParams = []) -> bool:
        ...
        if self.isFunction:
            ...
            #totalParams = [x for x in totalParams if x != None]
...
def createRandomTopTree():
    ...
    # Now we recurse
    leftSubtree = recursiveRandomTopSubtree(5, 0, 0.9)
    rightSubtree = recursiveRandomTopSubtree(5, 0, 0.9)
