...
% Curriculum Training
 ...
 For all the following tests, I set the following structure for each tree:
...
\subsection{Generating Initial Fixed Size Population}
...
2. Many of the competitors in the original 2018 competition organized their decision making by phase of the game.

3. Focus on developing military rather than Mars

4. Take a built player and evolve the phases
...
\bibitem{battlecode}
	MIT's AI Challenge.
	\emph{Battlecode 2018 Gameplay Specifications v1.2.0}
	%https://s3.amazonaws.com/battlecode-2018/specs/battlecode-specs-2018.html
